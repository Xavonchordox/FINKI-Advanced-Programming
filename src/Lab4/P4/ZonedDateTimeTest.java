...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeOf() {
         ...
         */
        LocalDateTime ldt = LocalDateTime.of(2015, 7, 10, 2, 14, 25, 0);
        ZoneId japan = ZoneId.of("Asia/Tokyo");
        ZonedDateTime zdt = ZonedDateTime.of(ldt, japan);
        return zdt;
    }
    ...
    static ZonedDateTime zonedDateTimeParse() {
         ...
         */
        String str = "2015-06-18T23:07:25+09:00[Asia/Tokyo]";
    ...
    static String zonedDateTimeFormat() {
         ...
         */
        String str = zdt.format(DateTimeFormatter.ofPattern("yyyy_MM_dd_HH_mm_ss_z"));
        return str;
    }
    ...
    static ZonedDateTime sameInstantAs() {
         ...
         */
        ZonedDateTime zone = zdt.withZoneSameInstant(ZoneId.of("America/Los_Angeles"));
    ...
    static ZonedDateTime sameLocalAs() {
         ...
         */
        ZonedDateTime zone = zdt.withZoneSameLocal(ZoneId.of("America/Los_Angeles"));
