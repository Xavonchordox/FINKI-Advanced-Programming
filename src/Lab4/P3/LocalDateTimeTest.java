...
public class LocalDateTimeTest {
    ...
    static LocalDateTime localDateTimeParse() {
         ...
         */
        String time = "2015-06-20T23:07:30";
    ...
    static LocalDateTime localTimeWith() {
         ...
         */
        LocalDateTime time = ldt.plusMonths(1).withDayOfMonth(1).truncatedTo(ChronoUnit.HOURS);
    ...
    static LocalDateTime localDatePlusMinus() {
         ...
         */
        LocalDateTime time = ldt.plusMonths(10).minusHours(5);
        return time;
    }
